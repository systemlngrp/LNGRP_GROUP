...
export interface GateEntry {
  ...
  orderFirmId?: string;
  sourceFirmId?: string;
  destinationFirmId?: string;
  sourceTransactionType?: string;
  sourceTransactionId?: string;
  interFirmFlow?: "Yes" | "No" | string;
  autoGenerated?: "Yes" | "No" | string;
  linkedGateEntryId?: string;
  linkedMrrId?: string;
...
export interface MaterialIn {
  ...
  invDate: string;
  supplierId: string;
  mrrSource?: "Manual" | "System Generated" | string;
  orderFirmId?: string;
  sourceFirmId?: string;
  destinationFirmId?: string;
  sourceTransactionType?: string;
