...
export function GateEntryMaster({ cancelledOnly = false }: GateEntryMasterProps = {}) {
  ...
  const filteredEntries = useMemo(
    ...
    [baseEntries, cancelledOnly, searchTerm, suppliers, companies, firms, firmFilter, supplierFilter, truckFilter, dateFrom, dateTo, mrrStatusFilter]
  );
  ...
  const tableHeadings = cancelledOnly
    ? ["Gate Entry No", "Firm", "Source", "Date", "Supplier Name", "Invoice No", "Invoice Value", "Truck No", "Cancel Details", "Photos", "Action"]
    : ["Gate Entry No", "Firm", "Source", "Date", "Supplier Name", "Invoice No", "Invoice Value", "Truck No", "Status", "MRR No", "Cancel Details", "Photos", "Action"];
                  ...
                  return (
                    <tr key={entry.id} className={cancelled ? "bg-red-50/50" : "hover:bg-slate-50"}>
                      ...
                      <td className="border border-black px-4 py-3 text-sm text-black">
                        <span className={`rounded-full px-2 py-1 text-[10px] font-bold uppercase ${entry.autoGenerated === "Yes" ? "bg-blue-100 text-blue-800" : "bg-slate-100 text-slate-700"}`}>
                          {entry.autoGenerated === "Yes" ? "Auto" : "Manual"}
                        </span>
                      </td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="max-h-[85vh] w-full max-w-5xl overflow-y-auto rounded-[24px] border border-slate-200 bg-white p-6 shadow-2xl">
            ...
            <div className="grid gap-4 md:grid-cols-4">
              ...
              <InfoCard label="Source" value={selectedEntry.autoGenerated === "Yes" ? "System Generated" : "Manual"} />
