...
export function CanceledOrders() {
  ...
  }, [companies, companyFilter, firmFilter, itemFilter, orders, resolveOrderItem, searchTerm]);
          ...
          <tbody>
            {canceledRows.map(({ order: o, company, item }) => (
              <tr key={o.id} className="hover:bg-slate-50">
                ...
                <td className="px-3 py-2 border border-black">{getFirmDisplayNameById(o.firmId, firms, o.firmName)}</td>
